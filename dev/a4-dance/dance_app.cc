...
DanceApp::DanceApp() : GraphicsApp(1280, 768, "So You Think Ants Can Dance") {
    ...
    //I choose my own motion from the data base use the name given in the head file
    ballet_special1_.LoadFromAMC(Platform::FindFile("05_02.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special1_.TrimFront(280);
    ballet_special1_.TrimBack(200);
    ballet_special1_.CalcRelativeTranslations();

    ballet_special2_.LoadFromAMC(Platform::FindFile("61_06.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special2_.TrimFront(400);
    ballet_special2_.TrimBack(400);
    ballet_special2_.CalcRelativeTranslations();

    ballet_special3_.LoadFromAMC(Platform::FindFile("60_12.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimFront(300);
    ballet_special3_.TrimBack(300);
    ballet_special3_.CalcRelativeTranslations();

    ballet_special4_.LoadFromAMC(Platform::FindFile("55_25.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special4_.TrimFront(250);
    ballet_special4_.TrimBack(300);
