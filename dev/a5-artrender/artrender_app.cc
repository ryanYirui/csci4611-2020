...
void ArtRenderApp::InitOpenGL() {
	...
	proj_matrix_ = Matrix4::Perspective(30, aspect_ratio(), 0.1, 50);
	...
	qs_light.diffuse_intensity = Color(0.4, 0.4, 0.4);
	qs_light.specular_intensity = Color(0, 0, 0);
...
void ArtRenderApp::DrawUsingOpenGL() {
	...
	Matrix4 light_model = Matrix4::Translation(light_pos_ - Point3(0, 0, 0)) *
		Matrix4::Scale(Vector3(0.1, 0.1, 0.1));
